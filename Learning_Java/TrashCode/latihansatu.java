        ...
        if (currentUser == null && !isAdminLoggedIn) {
            ...
            switch (userChoice) {
                ...
                if (statusCheckIn.equals("belum")) {
                    ...
                    System.out.println(ANSI_PURPLE + "═══════════════════════════════════════════════" + ANSI_RESET);
                    System.out.println(ANSI_CYAN + "Nama Pengguna           : " + ANSI_RESET + registerednamaPenggunas.get(userIndex) + ANSI_RESET);
                ...
                case 1:
                    ...
                    for (int i = 0; i < bookings.length; i++) {
                        if (bookings[i][0] != null) {
                            System.out.println("Nama Pengguna   : " + registerednamaPenggunas.get(i));
