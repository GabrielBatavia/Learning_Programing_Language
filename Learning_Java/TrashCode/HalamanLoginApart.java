...
public class HalamanLoginApart {
    ...
    public static void approveCheckOut(String username) {
        // Mencari pengguna dengan username
        for (String[] booking : bookings) {
            if (booking[0].equals(username) && booking[9].equals("pending checkout")) {
    ...
    while (isProgramRunning) {
        if (currentUser == null && !isAdminLoggedIn) {
            ...
            switch (adminChoice) {
                ...
                case 2:
                    ...
                    for (int i = 0; i < bookings.length; i++) {
                        if (bookings[i][0] != null && "Dipesan".equals(bookings[i][7]) && "belum".equals(bookings[i][8])) {
                            ...
                            HalamanLoginApart.approveCheckIn(usernameCheckIn);
                            break;
                        }
                    }
                    break;
                ...
                HalamanLoginApart.approveCheckOut(usernameCheckOut);
                    break;
