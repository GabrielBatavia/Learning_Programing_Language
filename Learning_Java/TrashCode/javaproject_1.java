    ...
    while (isProgramRunning) {
        if (currentUser == null && !isAdminLoggedIn) {
            ...
            switch (userChoice) {
                ...
                } else if (statusCheckIn.equals(STATUS_APPROVED_CHECKIN)) {
                ...
                */
                ...
                } else if (statusCheckIn.equals(STATUS_APPROVED_CHECKOUT)) {
            ...
            switch (adminChoice) {
                ...
                case 2:
                    ...
                    for (int i = 0; i < bookings.length; i++) {
                        if (bookings[i] != null && bookings[i][8].equals(STATUS_PENDING_CHECKIN)) {
                    ...
                    for (int i = 0; i < registeredUsernames.size(); i++) {
                        if (registeredUsernames.get(i).equals(usernameCheckIn)) {
                ...
                for (int i = 0; i < bookings.length; i++) {
                    if (bookings[i] != null && bookings[i][8].equals(STATUS_PENDING_CHECKOUT)) {
                ...
                for (int i = 0; i < registeredUsernames.size(); i++) {
                    if (registeredUsernames.get(i).equals(usernameCheckOut)) {
