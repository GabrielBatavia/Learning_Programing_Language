...
public class AkuBelajar {
    ...
    public static void userInformation(ArrayList<User> users, String[][] bookings, int userIndex) {
        ...
        System.out.println(         "╔════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗");
        System.out.println(ANSI_CYAN +"║ "+ANSI_CYAN+"      ░▀█▀░█▀█░█▀▀░█▀█░█▀▄░█▄█░█▀█░█▀▀░▀█▀░░░█▀█░█▀▀░█▄█░█▀▀░█▀▀░█▀█░█▀█░█▀█░█▀█░░░█▀█░█▀▀░█▀█░█▀▀░█▀▀░█░█░█▀█░█▀█░░░░         "+ ANSI_RESET +"║");
        System.out.println(ANSI_CYAN +"║ "+ANSI_CYAN+"      ░░█░░█░█░█▀▀░█░█░█▀▄░█░█░█▀█░▀▀█░░█░░░░█▀▀░█▀▀░█░█░█▀▀░▀▀█░█▀█░█░█░█▀█░█░█░░░█▀▀░█▀▀░█░█░█░█░█░█░█░█░█░█░█▀█░░░░         "+ ANSI_RESET +"║");
        System.out.println(ANSI_CYAN +"║ "+ANSI_CYAN+"      ░▀▀▀░▀░▀░▀░░░▀▀▀░▀░▀░▀░▀░▀░▀░▀▀▀░▀▀▀░░░▀░░░▀▀▀░▀░▀░▀▀▀░▀▀▀░▀░▀░▀░▀░▀░▀░▀░▀░░░▀░░░▀▀▀░▀░▀░▀▀▀░▀▀▀░▀▀▀░▀░▀░▀░▀░░░░         "+ ANSI_RESET +"║");
        System.out.println("╚══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝");
        ...
        for (int i = 0; i < bookings.length; i++) {
            if (bookings[i][0] != null) {
                System.out.println("Username            : " + registeredUsernames.get(i));
                System.out.println("Tipe Kamar          : " + bookings[i][0]);
                System.out.println("Tanggal Reservasi   :" + bookings[i][1]);
    ...
    private static void purchaseMembership(User user, Scanner input) {
        ...
        if (response.equalsIgnoreCase("Ya")) {
            System.out.print("Silakan bayar biaya membership sekarang: Rp 200,000. Masukkan jumlah yang dibayar: ");
